...
- [/] Migrar endpoint de transcrição (Whisper) do `server.js` (Express) para Deno no Supabase.
- [/] Remover servidor Node.js e tornar a aplicação 100% serverless/frontend.
